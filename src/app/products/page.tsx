...
function getProductModelProps(product: Product) {
  const map: Record<string, { type: string; color: string; metalness: number; roughness: number }> = {
    ...
    'sluice-valve':           { type: 'gate-valve',      color: '#1d4ed8', metalness: 0.5,  roughness: 0.42 },
    'air-valve':              { type: 'air-valve',       color: '#1d4ed8', metalness: 0.5,  roughness: 0.42 },
    ...
    'di-flanged-spigot':      { type: 'flanged-spigot',  color: '#2a2f38', metalness: 0.5,  roughness: 0.55 },
    ...
    'di-duckfoot-bend-90':    { type: 'duckfoot-bend-90',color: '#2a2f38', metalness: 0.5,  roughness: 0.55 },
    ...
    'di-socket-bend-90':      { type: 'socket-bend-90',  color: '#2a2f38', metalness: 0.5,  roughness: 0.55 },
    ...
    'di-mj-collar':           { type: 'mj-collar',       color: '#2a2f38', metalness: 0.5,  roughness: 0.55 },
    ...
    'di-puddle-pipe':         { type: 'puddle-pipe',     color: '#2a2f38', metalness: 0.5,  roughness: 0.55 },
    'di-single-flange-pipe':  { type: 'single-flange-pipe', color: '#2a2f38', metalness: 0.5,  roughness: 0.55 },
